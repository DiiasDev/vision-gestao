...
import {} from "../../types/Clients/ClientsTypes.js";
export class ClientsService {
    async newClient(clientes) {
        try {
            const pool = DB.connect();
            const { nome_completo, tipo_de_cliente, cpf_cnpj, email, telefone, cidade, endereco, obs, status, } = clientes;
    ...
    async updateClient(id, clientes) {
        try {
            const pool = DB.connect();
            const { nome_completo, tipo_de_cliente, cpf_cnpj, email, telefone, cidade, endereco, obs, status, } = clientes;
            if (!id) {
